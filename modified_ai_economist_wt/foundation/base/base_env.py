...
from modified_ai_economist_wt.foundation.base.base_agent import agent_registry
from modified_ai_economist_wt.foundation.base.registrar import Registry
from modified_ai_economist_wt.foundation.base.world import World
from modified_ai_economist_wt.foundation.base.base_component import component_registry
from modified_ai_economist_wt.foundation.entities.endogenous import endogenous_registry
from modified_ai_economist_wt.foundation.entities.landmarks import landmark_registry
from modified_ai_economist_wt.foundation.entities.resources import resource_registry
...
class BaseEnvironment(ABC):
    ...
    Example:
        ...
        # see ../components/move.py and ../components/continuous_double_auction.py and ../components/vote_and_invest_component.py and ../components/teach_and_build_component.py
        ...
        CommunicateComponentClass = foundation.components.get("TeachBuild")
    ...
    Example:
        ...
        env = ScenarioClass(
            components=[
                ...
                ("TeachBuild", {"payment": 10, "payment_max_skill_multiplier": np.array([15, 15])}),
            ],
            n_agents=6,
            world_size=[40, 40],
        )
    ...
    def __init__(
        ...
        self._entities = {
            "resources": ["Coin"],
            "landmarks": [],
            "endogenous": ["Labor", "VoteInvest", "Teaching"],
        }
