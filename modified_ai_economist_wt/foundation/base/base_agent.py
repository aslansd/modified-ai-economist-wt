...
class BaseAgent:
    ...
    def action_spaces(self):
        ...
        if self.multi_action_mode == True:
            ...
            Example:
                ...
                [5, 25, 3]
                >> self._action_names
                ["Gather", "VoteInvest", "Teaching"]
                # [4 Gather actions + Gather NO-OP, 24 VoteInvest actions + VoteInvest NO-OP, 2 Teaching action + Teaching NO-OP]
        ...
        if self.multi_action_mode == False:
            ...
            Example:
                ...
                >> self._action_names
                ["Gather", "VoteInvest", "Teaching"]
                # 1 NO-OP + 4 Gather actions + 24 VoteInvest actions + 2 Teaching action
        """
    ...
    def endogenous(self):
        ...
        Example:
            >> self.endogenous
            {"Labor": 30.25, "VoteInvest": [1.0, 2.0, 3.0], "Teaching": ['teacher', ['a', 'b', 'c', 'd']]}
        """
